...
Schism is a JUCE-based dual-view DSP environment prototype:

- Left: visual graph patch canvas
- Right: text graph language editor (SC-inspired syntax)
- One canonical internal model: Graph IR
